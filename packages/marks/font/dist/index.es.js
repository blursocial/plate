import { getNodeDeserializer, getLeafOverrideProps } from '@udecode/plate-common';
...
const getFontColorOverrideProps = () => editor => {
  const {
    ...
    defaultColor,
    classNames
  } = getPlatePluginOptions(editor, MARK_COLOR);
...
const getFontBackgroundColorOverrideProps = () => editor => {
  const {
    ...
    defaultColor,
    classNames
  } = getPlatePluginOptions(editor, MARK_BG_COLOR);
  return getLeafOverrideProps(editor, {
    type: MARK_BG_COLOR,
    defaultOption: defaultColor,
    options: colors,
...
const getFontFamilyOverrideProps = () => editor => {
  const {
    ...
    defaultFontFamily,
    classNames
  } = getPlatePluginOptions(editor, MARK_FONT_FAMILY);
  return getLeafOverrideProps(editor, {
...
const getFontSizeOverrideProps = () => editor => {
  const {
    ...
    defaultFontSize,
    classNames
  } = getPlatePluginOptions(editor, MARK_FONT_SIZE);
  return getLeafOverrideProps(editor, {
    type: MARK_FONT_SIZE,
...
const getFontWeightOverrideProps = () => editor => {
  const {
    ...
    defaultFontWeight,
    classNames
  } = getPlatePluginOptions(editor, MARK_FONT_WEIGHT);
  return getLeafOverrideProps(editor, {
...
export { MARK_BG_COLOR, MARK_COLOR, MARK_FONT_FAMILY, MARK_FONT_SIZE, MARK_FONT_WEIGHT, createFontBackgroundColorPlugin, createFontColorPlugin, createFontFamilyPlugin, createFontSizePlugin, createFontWeightPlugin, getFontBackgroundColorDeserialize, getFontColorDeserialize, getFontFamilyDeserialize, getFontSizeDeserialize, getFontWeightDeserialize };
