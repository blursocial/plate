...
function getOverrideProps(editor, {
  ...
  const pluginOptions = plateCore.getPlatePluginOptions(editor, type);
  const {
    cssPropName,
    transformCssValue
  } = pluginOptions;
...
exports.getElementOverrideProps = getElementOverrideProps;
...
exports.getLeafOverrideProps = getLeafOverrideProps;
