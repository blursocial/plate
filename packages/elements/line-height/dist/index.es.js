...
const setLineHeight = (editor, {
  ...
  const match = n => Editor.isBlock(editor, n) && types.includes(n.type);
...
export { DEFAULT_LINE_HEIGHT, DEFAULT_LINE_HEIGHTS, KEY_LINE_HEIGHT, createLineHeightPlugin, getLineHeightOverrideProps, setLineHeight };
