...
const getButtonStyles = props => {
  ...
  return plateStyledComponents.createStyles({
    ...
    root: [{
      ...
      paddingTop: py,
      paddingBottom: py
    }, Ce(["font-family:inherit;font-size:14px;border-radius:3px;"])]
  });
};
...
const Button = ({
  ...
  return /*#__PURE__*/r__default['default'].createElement(_StyledButton, _extends({
...
var _StyledButton = He("button").withConfig({
  displayName: "Button___StyledButton",
  componentId: "sc-1k4fo9r-0"
})(["", ""], p => p.$_css);

const Icon = /*#__PURE__*/r.forwardRef((props, ref) => {
  const {
    children,
    iconVerticalAlign,
    size,
  ...
  return /*#__PURE__*/r__default['default'].createElement("svg", _extends({}, iconProps, {
    ref: ref
  }), title && /*#__PURE__*/r__default['default'].createElement("title", {
    key: "icon-title"
  }, title), children);
});
const StyledIcon = He(Icon).withConfig({
  displayName: "StyledIcon",
  componentId: "sc-1lmwuuu-0"
})(["display:inline-block;vertical-align:", ";overflow:hidden;height:100%;"], props => props.iconVerticalAlign);

const DeleteIcon = props => /*#__PURE__*/r__default['default'].createElement(StyledIcon, _extends({
  viewBox: "0 0 24 24",
  fill: "currentColor"
}, props), /*#__PURE__*/r__default['default'].createElement("title", null, "Delete icon"), /*#__PURE__*/r__default['default'].createElement("path", {
  fill: "none",
  d: "M0 0h24v24H0z"
}), /*#__PURE__*/r__default['default'].createElement("path", {
...
const RemoveNodeButton = ({
  ...
  return /*#__PURE__*/r__default['default'].createElement(Button, _extends({
    size: 24,
    py: 4,
    onClick: () => {
  ...
  }, props), /*#__PURE__*/r__default['default'].createElement(DeleteIcon, null));
};

const ChevronDownIcon = props => /*#__PURE__*/r__default['default'].createElement(_StyledStyledIcon, _extends({
  viewBox: "0 0 24 24",
  focusable: "false",
  "aria-hidden": "true"
}, props), /*#__PURE__*/r__default['default'].createElement("path", {
  fill: "currentColor",
  d: "M16.59 8.59L12 13.17 7.41 8.59 6 10l6 6 6-6z"
}));

var _StyledStyledIcon = He(StyledIcon).withConfig({
