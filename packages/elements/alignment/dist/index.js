...
const DEFAULT_ALIGNMENTS = ['left', 'center', 'right', 'justify'];
...
const setAlign = (editor, {
  ...
  if (align === defaultAlignment) {
    plateCommon.unsetNodes(editor, 'align', {
      match,
      ...options
    });
  } else {
...
exports.DEFAULT_ALIGNMENTS = DEFAULT_ALIGNMENTS;
exports.KEY_ALIGN = KEY_ALIGN;
exports.createAlignPlugin = createAlignPlugin;
exports.getAlignOverrideProps = getAlignOverrideProps;
