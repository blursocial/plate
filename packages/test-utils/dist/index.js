...
function createEditor(tagName, attributes, children) {
  ...
  for (const [node, path] of slate.Node.texts(editor)) {
...
exports.FocusToken = FocusToken;
exports.Token = Token;
exports.addAnchorToken = addAnchorToken;
exports.addFocusToken = addFocusToken;
...
exports.getFocusOffset = getFocusOffset;
