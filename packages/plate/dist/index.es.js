...
import { MARK_BOLD, MARK_CODE, MARK_ITALIC, MARK_STRIKETHROUGH, MARK_SUBSCRIPT, MARK_SUPERSCRIPT, MARK_UNDERLINE, DEFAULTS_BOLD, DEFAULTS_CODE, DEFAULTS_ITALIC, DEFAULTS_STRIKETHROUGH, DEFAULTS_SUBSCRIPT, DEFAULTS_SUPERSCRIPT, DEFAULTS_UNDERLINE } from '@udecode/plate-basic-marks';
export * from '@udecode/plate-basic-marks';
import { ELEMENT_BLOCKQUOTE, DEFAULTS_BLOCKQUOTE } from '@udecode/plate-block-quote';
...
import { withPlate, createReactPlugin, createHistoryPlugin } from '@udecode/plate-core';
...
import { ELEMENT_H1, ELEMENT_H2, ELEMENT_H3, ELEMENT_H4, ELEMENT_H5, ELEMENT_H6, DEFAULTS_H1, DEFAULTS_H2, DEFAULTS_H3 } from '@udecode/plate-heading';
export * from '@udecode/plate-heading';
import { MARK_HIGHLIGHT, DEFAULTS_HIGHLIGHT } from '@udecode/plate-highlight';
export * from '@udecode/plate-highlight';
import { ELEMENT_HR } from '@udecode/plate-horizontal-rule';
export * from '@udecode/plate-horizontal-rule';
import { createStyles, StyledElement, StyledLeaf } from '@udecode/plate-styled-components';
...
import { ELEMENT_LINK, DEFAULTS_LINK } from '@udecode/plate-link';
export * from '@udecode/plate-link';
import { LinkElement } from '@udecode/plate-link-ui';
export * from '@udecode/plate-link-ui';
import { ELEMENT_LI, ELEMENT_UL, ELEMENT_OL, ELEMENT_TODO_LI, DEFAULTS_TODO_LIST } from '@udecode/plate-list';
...
import { MentionElement, MentionInputElement } from '@udecode/plate-mention-ui';
export * from '@udecode/plate-mention-ui';
export * from '@udecode/plate-node-id';
export * from '@udecode/plate-normalizers';
import { ELEMENT_PARAGRAPH, DEFAULTS_PARAGRAPH } from '@udecode/plate-paragraph';
...
import { ELEMENT_TABLE, ELEMENT_TD, ELEMENT_TH, ELEMENT_TR, DEFAULTS_TD, DEFAULTS_TH } from '@udecode/plate-table';
export * from '@udecode/plate-table';
import { TableElement, TableCellElement, TableRowElement } from '@udecode/plate-table-ui';
...
ue.Consumer;
var de = /*#__PURE__*/r.createContext(),
...
var Le = /*#__PURE__*/r.createContext();
Le.Consumer;
var Ye = {};
  ...
  var C,
    ...
    return function (e, t, n, r) {
      ...
      var f = function (e, t, n) {
        ...
        return useDebugValue(i), !t && r && r(i), i;
      ...
      return t.style && g.style !== t.style && (C.style = v({}, t.style, {}, g.style)), C.className = Array.prototype.concat(c, h, S !== h ? S : null, t.className, g.className).filter(Boolean).join(" "), C.ref = w, /*#__PURE__*/createElement(_, C);
    }(C, e, t, P);
  };
...
const HrElement = props => {
  ...
  return /*#__PURE__*/r.createElement(_StyledDiv, _extends({}, attributes, {
  ...
  }), /*#__PURE__*/r.createElement(_StyledHr, _extends({
...
const createPlateComponents = overrides => {
  const components = {
    ...
    [ELEMENT_H1]: withProps(StyledElement, {
      as: 'h1',
      styles: {
        root: css(["margin:2em 0 4px;font-size:1.875em;font-weight:500;line-height:1.3;"])
      }
    }),
    [ELEMENT_H2]: withProps(StyledElement, {
      as: 'h2',
      styles: {
        root: css(["margin:1.4em 0 1px;font-size:1.5em;font-weight:500;line-height:1.3;"])
      }
    }),
    [ELEMENT_H3]: withProps(StyledElement, {
      as: 'h3',
      styles: {
        root: css(["margin:1em 0 1px;font-size:1.25em;font-weight:500;line-height:1.3;color:#434343;"])
      }
    }),
    [ELEMENT_H4]: withProps(StyledElement, {
      as: 'h4',
      styles: {
        root: css(["margin:0.75em 0 0;font-size:1.1em;font-weight:500;line-height:1.3;color:#666666;"])
      }
    }),
    ...
    [ELEMENT_UL]: withProps(StyledElement, {
      as: 'ul',
      styles: {
        root: css(["margin:0;padding-inline-start:24px;"])
      }
    }),
    ...
    [ELEMENT_TH]: withProps(StyledElement, {
      ...
      styles: {
        root: [{
          "padding": "0.5rem",
          "textAlign": "left"
        }, css(["background-color:rgb(244,245,247);border:1px solid rgb(193,199,208);min-width:48px;> *{margin:0;}"])]
      }
    }),
    ...
    [MARK_CODE]: withProps(StyledLeaf, {
      ...
      styles: {
        root: [{
          "whiteSpace": "pre-wrap"
        }, css(["font-size:85%;font-family:'SFMono-Regular',Consolas,'Liberation Mono',Menlo,Courier,monospace;background-color:rgba(135,131,120,0.15);border-radius:3px;padding:0.2em 0.4em;line-height:normal;"])]
      }
    }),
    ...
    [MARK_KBD]: withProps(StyledLeaf, {
      ...
      styles: {
        root: [{
          "whiteSpace": "pre-wrap"
        }, css(["font-size:75%;font-family:'SFMono-Regular',Consolas,'Liberation Mono',Menlo,Courier,monospace;background-color:white;border:1px solid black;border-radius:3px;padding:0.2em 0.4em;line-height:normal;margin-right:0.2em;box-shadow:2px 2px 3px 0 rgba(0,0,0,0.75);"])]
      }
    }),
...
export { HrElement, createEditorPlugins, createPlateComponents, createPlateOptions, getHrElementStyles };
