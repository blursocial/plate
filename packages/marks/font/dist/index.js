...
const getFontColorDeserialize = () => editor => {
  const options = plateCore.getPlatePluginOptions(editor, MARK_COLOR);
  return {
    leaf: plateCommon.getNodeDeserializer({
      type: options.type,
      getNode: element => ({
        [options.type]: element.style.color
      }),
      rules: [{
        style: {
          color: '*'
...
const getFontBackgroundColorDeserialize = () => editor => {
  const options = plateCore.getPlatePluginOptions(editor, MARK_BG_COLOR);
  return {
    leaf: plateCommon.getNodeDeserializer({
      type: options.type,
      getNode: element => ({
        [options.type]: element.style.backgroundColor
      }),
      rules: [{
        style: {
          backgroundColor: '*'
...
const getFontSizeDeserialize = () => editor => {
  ...
  return {
    leaf: plateCommon.getNodeDeserializer({
      type: options.type,
      getNode: element => ({
        [options.type]: element.style.fontSize
      }),
      rules: [{
        style: {
          fontSize: '*'
...
const getFontWeightDeserialize = () => editor => {
  const options = plateCore.getPlatePluginOptions(editor, MARK_FONT_WEIGHT);
  return {
    leaf: plateCommon.getNodeDeserializer({
      type: options.type,
      getNode: element => ({
        [options.type]: element.style.fontWeight
      }),
      rules: [{
        style: {
          fontWeight: '*'
...
const getFontFamilyDeserialize = () => editor => {
  const options = plateCore.getPlatePluginOptions(editor, MARK_FONT_FAMILY);
  return {
    leaf: plateCommon.getNodeDeserializer({
      type: options.type,
      getNode: element => ({
        [options.type]: element.style.fontFamily
      }),
      rules: [{
        style: {
          fontFamily: '*'
...
const getFontColorOverrideProps = () => editor => {
  const {
    colors,
    defaultColor,
    classNames
  } = plateCore.getPlatePluginOptions(editor, MARK_COLOR);
  return plateCommon.getLeafOverrideProps(editor, {
    type: MARK_COLOR,
...
const getFontBackgroundColorOverrideProps = () => editor => {
  const {
    colors,
    defaultColor,
    classNames
  } = plateCore.getPlatePluginOptions(editor, MARK_BG_COLOR);
  return plateCommon.getLeafOverrideProps(editor, {
    type: MARK_BG_COLOR,
    defaultOption: defaultColor,
    options: colors,
...
const getFontFamilyOverrideProps = () => editor => {
  const {
    fontFamilies,
    defaultFontFamily,
    classNames
  } = plateCore.getPlatePluginOptions(editor, MARK_FONT_FAMILY);
  return plateCommon.getLeafOverrideProps(editor, {
...
const getFontSizeOverrideProps = () => editor => {
  const {
    fontSizes,
    defaultFontSize,
    classNames
  } = plateCore.getPlatePluginOptions(editor, MARK_FONT_SIZE);
  return plateCommon.getLeafOverrideProps(editor, {
    type: MARK_FONT_SIZE,
...
const getFontWeightOverrideProps = () => editor => {
  const {
    fontWeights,
    defaultFontWeight,
    classNames
  } = plateCore.getPlatePluginOptions(editor, MARK_FONT_WEIGHT);
  return plateCommon.getLeafOverrideProps(editor, {
...
const createFontBackgroundColorPlugin = (options = {}) => ({
  ...
  withOverrides: editor => {
    ...
    editor.options[MARK_BG_COLOR] = defaults_1(options, {
      type: MARK_BG_COLOR
    });
    return editor;
  }
...
const createFontColorPlugin = (options = {}) => ({
  overrideProps: getFontColorOverrideProps(),
  deserialize: getFontColorDeserialize(),
  withOverrides: editor => {
    // TODO: extend plate-core to register options
    editor.options[MARK_COLOR] = defaults_1(options, {
      type: MARK_COLOR
    });
    return editor;
  }
...
const createFontFamilyPlugin = (options = {}) => ({
  overrideProps: getFontFamilyOverrideProps(),
  deserialize: getFontFamilyDeserialize(),
  withOverrides: editor => {
    // TODO: extend plate-core to register options
    editor.options[MARK_FONT_FAMILY] = defaults_1(options, {
      type: MARK_FONT_FAMILY
    });
    return editor;
  }
...
const createFontSizePlugin = (options = {}) => ({
  overrideProps: getFontSizeOverrideProps(),
  deserialize: getFontSizeDeserialize(),
  withOverrides: editor => {
    // TODO: extend plate-core to register options
    editor.options[MARK_FONT_SIZE] = defaults_1(options, {
      type: MARK_FONT_SIZE
    });
    return editor;
  }
...
const createFontWeightPlugin = (options = {}) => ({
  overrideProps: getFontWeightOverrideProps(),
  deserialize: getFontWeightDeserialize(),
  withOverrides: editor => {
    // TODO: extend plate-core to register options
    editor.options[MARK_FONT_WEIGHT] = defaults_1(options, {
      type: MARK_FONT_WEIGHT
    });
    return editor;
  }
...
exports.getFontBackgroundColorDeserialize = getFontBackgroundColorDeserialize;
exports.getFontColorDeserialize = getFontColorDeserialize;
exports.getFontFamilyDeserialize = getFontFamilyDeserialize;
exports.getFontSizeDeserialize = getFontSizeDeserialize;
exports.getFontWeightDeserialize = getFontWeightDeserialize;
