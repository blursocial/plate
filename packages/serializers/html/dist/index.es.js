import { isElement, getPlatePluginWithOverrides, pipeOverrideProps } from '@udecode/plate-core';
...
const withDeserializeHTML = ({
  ...
  editor.insertData = data => {
    ...
    const isEnabled = isDeserializerEnabled(editor, plugins, htmlDeserializerId);
...
const getLeaf = (editor, {
  ...
  return plugins.reduce((result, plugin) => {
    ...
    leafProps = { ...pipeOverrideProps(leafProps, overriders),
...
export { createDeserializeHTMLPlugin, deserializeHTMLElement, deserializeHTMLNode, deserializeHTMLToBreak, deserializeHTMLToDocumentFragment, deserializeHTMLToElement, deserializeHTMLToFragment, deserializeHTMLToMarks, deserializeHTMLToText, htmlDeserializerId, htmlStringToDOMNode, serializeHTMLFromNodes, withDeserializeHTML };
