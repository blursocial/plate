...
var plateCsvSerializer = require('@udecode/plate-csv-serializer');
var plateDnd = require('@udecode/plate-dnd');
var plateFindReplace = require('@udecode/plate-find-replace');
var plateFindReplaceUi = require('@udecode/plate-find-replace-ui');
var plateFont = require('@udecode/plate-font');
var plateFontUi = require('@udecode/plate-font-ui');
...
var plateImageUi = require('@udecode/plate-image-ui');
...
var plateLineHeightUi = require('@udecode/plate-line-height-ui');
var plateLink = require('@udecode/plate-link');
var plateLinkUi = require('@udecode/plate-link-ui');
...
var plateMentionUi = require('@udecode/plate-mention-ui');
...
var platePlaceholder = require('@udecode/plate-placeholder');
...
var plateTableUi = require('@udecode/plate-table-ui');
...
var global$1 = typeof global$2 !== "undefined" ? global$2 : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {}; // shim for using process in browser
...
var g = function (e, t) {
  ...
  return n;
    ...
    S = function (t) {
  return null !== t && "object" == typeof t && "[object Object]" === (t.toString ? t.toString() : Object.prototype.toString.call(t)) && !reactIs_1(t);
},
    w = Object.freeze([]),
    E = Object.freeze({});
...
var A = "undefined" != typeof process && process.env.SC_ATTR || "data-styled",
    I = "undefined" != typeof window && "HTMLElement" in window,
    P = Boolean("boolean" == typeof SC_DISABLE_SPEEDY ? SC_DISABLE_SPEEDY : "undefined" != typeof process && void 0 !== process.env.REACT_APP_SC_DISABLE_SPEEDY && "" !== process.env.REACT_APP_SC_DISABLE_SPEEDY ? process.env.REACT_APP_SC_DISABLE_SPEEDY : "undefined" != typeof process && void 0 !== process.env.SC_DISABLE_SPEEDY && "" !== process.env.SC_DISABLE_SPEEDY ? process.env.SC_DISABLE_SPEEDY : "production" !== process.env.NODE_ENV),
    R = {
...
var T = function () {
  ...
  var t = V++;
  return ((0 | t) < 0 || t > 1 << 30) && j(16, "" + t), k.set(e, t), x.set(t, e), t;
},
    M = function (e) {
  return x.get(e);
},
...
var oe = ne("5.3.1"),
    se = function () {
  function e(e, t, n) {
    this.rules = e, this.staticRulesId = "", this.isStatic = "production" === process.env.NODE_ENV, this.componentId = t, this.baseHash = te(oe, t), this.baseStyle = n, Z.registerId(t);
  }
...
var ue = /*#__PURE__*/r__default['default'].createContext();
ue.Consumer;
var de = /*#__PURE__*/r__default['default'].createContext(),
    he = (de.Consumer, new Z()),
    pe = ce();

function fe() {
  return r.useContext(ue) || he;
}

function me() {
  return r.useContext(de) || pe;
}
...
function Ne(e, n, r, o) {
  ...
  if (b(e)) {
    ...
    var u = e(n);
    return reactIs_2(u) && console.warn(_(e) + " is not a styled component and cannot be referred to via component selector. See https://www.styled-components.com/docs/advanced#referring-to-other-components for more details."), Ne(u, n, r, o);
  }
...
var Ie = /invalid hook call/i,
    ...
    Oe = function (e, t) {
  {
    ...
    try {
      ...
      }, r.useRef(), o && !Pe.has(n) && (console.warn(n), Pe.add(n));
    } catch (e) {
...
var Le = /*#__PURE__*/r__default['default'].createContext();
Le.Consumer;
var Ye = {};
  ...
  var C,
    ...
    return function (e, t, n, r$1) {
      ...
      var f = function (e, t, n) {
        ...
        return r.useDebugValue(i), !t && r$1 && r$1(i), i;
      }(i, r$1, y, e.warnTooManyClasses),
          w = n,
      ...
      return t.style && g.style !== t.style && (C.style = v({}, t.style, {}, g.style)), C.className = Array.prototype.concat(c, h, S !== h ? S : null, t.className, g.className).filter(Boolean).join(" "), C.ref = w, /*#__PURE__*/r.createElement(_, C);
    }(C, e, t, P);
  };

  return O.displayName = f, (C = /*#__PURE__*/r__default['default'].forwardRef(O)).attrs = S, C.componentStyle = I, C.displayName = f, C.shouldForwardProp = A, C.foldedComponentIds = o ? Array.prototype.concat(e.foldedComponentIds, e.styledComponentId) : w, C.styledComponentId = g, C.target = o ? e.target : e, C.withComponent = function (e) {
    var r = t.componentId,
        o = function (e, t) {
      if (null == e) return {};
      var n,
...
var He = function (e) {
  return function e(t, r, o) {
    if (void 0 === o && (o = E), !reactIs_3(r)) return j(1, String(r));
...
const getHrElementStyles = props => {
  const {
    selected,
    focused
  } = props;
  return plateStyledComponents.createStyles({
    ...
    }, Ce(["height:2px;border-radius:1px;"]), selected && focused && {
      "--tw-bg-opacity": "1",
...
const HrElement = props => {
  ...
  const styles = getHrElementStyles({ ...props,
    selected,
    focused
  });
  return /*#__PURE__*/r__default['default'].createElement(_StyledDiv, _extends({}, attributes, {
    className: (_styles$root = styles.root) === null || _styles$root === void 0 ? void 0 : _styles$root.className
  }, rootProps, nodeProps, {
    $_css: (_styles$root2 = styles.root) === null || _styles$root2 === void 0 ? void 0 : _styles$root2.css
  }), /*#__PURE__*/r__default['default'].createElement(_StyledHr, _extends({
    contentEditable: false
  }, nodeProps, {
    className: (_styles$hr = styles.hr) === null || _styles$hr === void 0 ? void 0 : _styles$hr.className,
    $_css2: (_styles$hr2 = styles.hr) === null || _styles$hr2 === void 0 ? void 0 : _styles$hr2.css
  })), children);
};

var _StyledDiv = He("div").withConfig({
  displayName: "HrElement___StyledDiv",
  componentId: "sc-b8gu5u-0"
})(["", ""], p => p.$_css);

var _StyledHr = He("hr").withConfig({
  displayName: "HrElement___StyledHr",
  componentId: "sc-b8gu5u-1"
})(["", ""], p => p.$_css2);
...
const createPlateComponents = overrides => {
  const components = {
    ...
    [plateHorizontalRule.ELEMENT_HR]: HrElement,
    [plateHeading.ELEMENT_H1]: plateCommon.withProps(plateStyledComponents.StyledElement, {
      as: 'h1',
      styles: {
        root: styledComponents.css(["margin:2em 0 4px;font-size:1.875em;font-weight:500;line-height:1.3;"])
      }
    }),
    [plateHeading.ELEMENT_H2]: plateCommon.withProps(plateStyledComponents.StyledElement, {
      as: 'h2',
      styles: {
        root: styledComponents.css(["margin:1.4em 0 1px;font-size:1.5em;font-weight:500;line-height:1.3;"])
      }
    }),
    [plateHeading.ELEMENT_H3]: plateCommon.withProps(plateStyledComponents.StyledElement, {
      as: 'h3',
      styles: {
        root: styledComponents.css(["margin:1em 0 1px;font-size:1.25em;font-weight:500;line-height:1.3;color:#434343;"])
      }
    }),
    [plateHeading.ELEMENT_H4]: plateCommon.withProps(plateStyledComponents.StyledElement, {
      as: 'h4',
      styles: {
        root: styledComponents.css(["margin:0.75em 0 0;font-size:1.1em;font-weight:500;line-height:1.3;color:#666666;"])
      }
    }),
    ...
    [plateImage.ELEMENT_IMAGE]: plateImageUi.ImageElement,
    [plateList.ELEMENT_LI]: plateCommon.withProps(plateStyledComponents.StyledElement, {
      as: 'li'
    }),
    [plateLink.ELEMENT_LINK]: plateLinkUi.LinkElement,
    [plateMediaEmbed.ELEMENT_MEDIA_EMBED]: plateMediaEmbedUi.MediaEmbedElement,
    [plateMention.ELEMENT_MENTION]: plateMentionUi.MentionElement,
    [plateMention.ELEMENT_MENTION_INPUT]: plateMentionUi.MentionInputElement,
    [plateList.ELEMENT_UL]: plateCommon.withProps(plateStyledComponents.StyledElement, {
      as: 'ul',
      styles: {
        root: styledComponents.css(["margin:0;padding-inline-start:24px;"])
      }
    }),
    ...
    [plateTable.ELEMENT_TABLE]: plateTableUi.TableElement,
    [plateTable.ELEMENT_TD]: plateTableUi.TableCellElement,
    [plateTable.ELEMENT_TH]: plateCommon.withProps(plateStyledComponents.StyledElement, {
      as: 'th',
      styles: {
        root: [{
          "padding": "0.5rem",
          "textAlign": "left"
        }, styledComponents.css(["background-color:rgb(244,245,247);border:1px solid rgb(193,199,208);min-width:48px;> *{margin:0;}"])]
      }
    }),
    [plateList.ELEMENT_TODO_LI]: plateListUi.TodoListElement,
    [plateTable.ELEMENT_TR]: plateTableUi.TableRowElement,
    ...
    [plateBasicMarks.MARK_CODE]: plateCommon.withProps(plateStyledComponents.StyledLeaf, {
      ...
      styles: {
        root: [{
          "whiteSpace": "pre-wrap"
        }, styledComponents.css(["font-size:85%;font-family:'SFMono-Regular',Consolas,'Liberation Mono',Menlo,Courier,monospace;background-color:rgba(135,131,120,0.15);border-radius:3px;padding:0.2em 0.4em;line-height:normal;"])]
      }
    }),
    ...
    [plateKbd.MARK_KBD]: plateCommon.withProps(plateStyledComponents.StyledLeaf, {
      ...
      styles: {
        root: [{
          "whiteSpace": "pre-wrap"
        }, styledComponents.css(["font-size:75%;font-family:'SFMono-Regular',Consolas,'Liberation Mono',Menlo,Courier,monospace;background-color:white;border:1px solid black;border-radius:3px;padding:0.2em 0.4em;line-height:normal;margin-right:0.2em;box-shadow:2px 2px 3px 0 rgba(0,0,0,0.75);"])]
      }
    }),
...
const createPlateOptions = overrides => {
  const options = {
    [plateBlockQuote.ELEMENT_BLOCKQUOTE]: plateBlockQuote.DEFAULTS_BLOCKQUOTE,
    [plateCodeBlock.ELEMENT_CODE_BLOCK]: plateCodeBlock.DEFAULTS_CODE_BLOCK,
    [plateCodeBlock.ELEMENT_CODE_LINE]: {},
    [plateHeading.ELEMENT_H1]: plateHeading.DEFAULTS_H1,
    [plateHeading.ELEMENT_H2]: plateHeading.DEFAULTS_H2,
    [plateHeading.ELEMENT_H3]: plateHeading.DEFAULTS_H3,
    [plateHeading.ELEMENT_H4]: {},
    [plateHeading.ELEMENT_H5]: {},
    [plateHeading.ELEMENT_H6]: {},
    [plateImage.ELEMENT_IMAGE]: {},
    [plateList.ELEMENT_LI]: {},
    [plateLink.ELEMENT_LINK]: plateLink.DEFAULTS_LINK,
    [plateMediaEmbed.ELEMENT_MEDIA_EMBED]: {},
    [plateMention.ELEMENT_MENTION]: {},
    [plateMention.ELEMENT_MENTION_INPUT]: {},
    [plateList.ELEMENT_OL]: {},
    [plateParagraph.ELEMENT_PARAGRAPH]: plateParagraph.DEFAULTS_PARAGRAPH,
    [plateTable.ELEMENT_TABLE]: {},
    [plateTable.ELEMENT_TD]: plateTable.DEFAULTS_TD,
    [plateTable.ELEMENT_TH]: plateTable.DEFAULTS_TH,
    [plateList.ELEMENT_TODO_LI]: plateList.DEFAULTS_TODO_LIST,
    [plateTable.ELEMENT_TR]: {},
    ...
    [plateKbd.MARK_KBD]: {},
    [plateFindReplace.MARK_SEARCH_HIGHLIGHT]: {},
...
const createEditorPlugins = ({
  editor = slate.createEditor(),
  plugins = [],
  options,
  components
} = {}) => {
  return plateCore.withPlate({
    plugins: [plateCore.createReactPlugin(), plateCore.createHistoryPlugin(), ...plugins],
...
exports.getHrElementStyles = getHrElementStyles;
Object.keys(plateAlignment).forEach(function (k) {
            if (k !== 'default' && !exports.hasOwnProperty(k)) Object.defineProperty(exports, k, {
                        enumerable: true,
                        get: function () {
                                    return plateAlignment[k];
                        }
            });
});
Object.keys(plateAlignmentUi).forEach(function (k) {
            if (k !== 'default' && !exports.hasOwnProperty(k)) Object.defineProperty(exports, k, {
                        enumerable: true,
                        get: function () {
                                    return plateAlignmentUi[k];
                        }
            });
});
Object.keys(plateAstSerializer).forEach(function (k) {
            if (k !== 'default' && !exports.hasOwnProperty(k)) Object.defineProperty(exports, k, {
                        enumerable: true,
                        get: function () {
                                    return plateAstSerializer[k];
                        }
            });
});
...
Object.keys(plateBlockQuote).forEach(function (k) {
            if (k !== 'default' && !exports.hasOwnProperty(k)) Object.defineProperty(exports, k, {
                        enumerable: true,
                        get: function () {
                                    return plateBlockQuote[k];
                        }
            });
});
Object.keys(plateBlockQuoteUi).forEach(function (k) {
            if (k !== 'default' && !exports.hasOwnProperty(k)) Object.defineProperty(exports, k, {
                        enumerable: true,
                        get: function () {
                                    return plateBlockQuoteUi[k];
                        }
            });
});
...
Object.keys(plateCodeBlock).forEach(function (k) {
            if (k !== 'default' && !exports.hasOwnProperty(k)) Object.defineProperty(exports, k, {
                        enumerable: true,
                        get: function () {
                                    return plateCodeBlock[k];
                        }
            });
});
Object.keys(plateCodeBlockUi).forEach(function (k) {
            if (k !== 'default' && !exports.hasOwnProperty(k)) Object.defineProperty(exports, k, {
                        enumerable: true,
                        get: function () {
                                    return plateCodeBlockUi[k];
                        }
            });
});
...
Object.keys(plateCsvSerializer).forEach(function (k) {
            if (k !== 'default' && !exports.hasOwnProperty(k)) Object.defineProperty(exports, k, {
                        enumerable: true,
                        get: function () {
                                    return plateCsvSerializer[k];
                        }
            });
});
Object.keys(plateDnd).forEach(function (k) {
            if (k !== 'default' && !exports.hasOwnProperty(k)) Object.defineProperty(exports, k, {
                        enumerable: true,
                        get: function () {
                                    return plateDnd[k];
...
Object.keys(plateFindReplace).forEach(function (k) {
            if (k !== 'default' && !exports.hasOwnProperty(k)) Object.defineProperty(exports, k, {
                        enumerable: true,
                        get: function () {
                                    return plateFindReplace[k];
                        }
            });
});
Object.keys(plateFindReplaceUi).forEach(function (k) {
            if (k !== 'default' && !exports.hasOwnProperty(k)) Object.defineProperty(exports, k, {
                        enumerable: true,
                        get: function () {
                                    return plateFindReplaceUi[k];
                        }
            });
});
...
Object.keys(plateFontUi).forEach(function (k) {
            if (k !== 'default' && !exports.hasOwnProperty(k)) Object.defineProperty(exports, k, {
                        enumerable: true,
                        get: function () {
                                    return plateFontUi[k];
                        }
            });
});
...
Object.keys(plateHorizontalRule).forEach(function (k) {
            if (k !== 'default' && !exports.hasOwnProperty(k)) Object.defineProperty(exports, k, {
                        enumerable: true,
                        get: function () {
                                    return plateHorizontalRule[k];
                        }
            });
});
Object.keys(plateStyledComponents).forEach(function (k) {
            if (k !== 'default' && !exports.hasOwnProperty(k)) Object.defineProperty(exports, k, {
                        enumerable: true,
                        get: function () {
                                    return plateStyledComponents[k];
                        }
            });
});
Object.keys(plateHtmlSerializer).forEach(function (k) {
            if (k !== 'default' && !exports.hasOwnProperty(k)) Object.defineProperty(exports, k, {
                        enumerable: true,
                        get: function () {
                                    return plateHtmlSerializer[k];
                        }
            });
});
...
Object.keys(plateImageUi).forEach(function (k) {
            if (k !== 'default' && !exports.hasOwnProperty(k)) Object.defineProperty(exports, k, {
                        enumerable: true,
                        get: function () {
                                    return plateImageUi[k];
                        }
            });
});
...
Object.keys(plateLineHeight).forEach(function (k) {
            if (k !== 'default' && !exports.hasOwnProperty(k)) Object.defineProperty(exports, k, {
                        enumerable: true,
                        get: function () {
                                    return plateLineHeight[k];
                        }
            });
});
Object.keys(plateLineHeightUi).forEach(function (k) {
            if (k !== 'default' && !exports.hasOwnProperty(k)) Object.defineProperty(exports, k, {
                        enumerable: true,
                        get: function () {
                                    return plateLineHeightUi[k];
                        }
            });
});
...
Object.keys(plateLinkUi).forEach(function (k) {
            if (k !== 'default' && !exports.hasOwnProperty(k)) Object.defineProperty(exports, k, {
                        enumerable: true,
                        get: function () {
                                    return plateLinkUi[k];
                        }
            });
});
...
Object.keys(plateListUi).forEach(function (k) {
            if (k !== 'default' && !exports.hasOwnProperty(k)) Object.defineProperty(exports, k, {
                        enumerable: true,
                        get: function () {
                                    return plateListUi[k];
                        }
            });
});
Object.keys(plateMdSerializer).forEach(function (k) {
            if (k !== 'default' && !exports.hasOwnProperty(k)) Object.defineProperty(exports, k, {
                        enumerable: true,
                        get: function () {
                                    return plateMdSerializer[k];
                        }
            });
});
Object.keys(plateMediaEmbed).forEach(function (k) {
            if (k !== 'default' && !exports.hasOwnProperty(k)) Object.defineProperty(exports, k, {
                        enumerable: true,
                        get: function () {
                                    return plateMediaEmbed[k];
                        }
            });
});
Object.keys(plateMediaEmbedUi).forEach(function (k) {
            if (k !== 'default' && !exports.hasOwnProperty(k)) Object.defineProperty(exports, k, {
                        enumerable: true,
                        get: function () {
                                    return plateMediaEmbedUi[k];
                        }
            });
});
Object.keys(plateMention).forEach(function (k) {
            if (k !== 'default' && !exports.hasOwnProperty(k)) Object.defineProperty(exports, k, {
                        enumerable: true,
                        get: function () {
                                    return plateMention[k];
                        }
            });
});
Object.keys(plateMentionUi).forEach(function (k) {
            if (k !== 'default' && !exports.hasOwnProperty(k)) Object.defineProperty(exports, k, {
                        enumerable: true,
                        get: function () {
                                    return plateMentionUi[k];
                        }
            });
});
...
Object.keys(plateParagraph).forEach(function (k) {
            if (k !== 'default' && !exports.hasOwnProperty(k)) Object.defineProperty(exports, k, {
                        enumerable: true,
                        get: function () {
                                    return plateParagraph[k];
                        }
            });
});
Object.keys(platePlaceholder).forEach(function (k) {
            if (k !== 'default' && !exports.hasOwnProperty(k)) Object.defineProperty(exports, k, {
                        enumerable: true,
                        get: function () {
                                    return platePlaceholder[k];
                        }
            });
});
Object.keys(platePopper).forEach(function (k) {
            if (k !== 'default' && !exports.hasOwnProperty(k)) Object.defineProperty(exports, k, {
                        enumerable: true,
                        get: function () {
                                    return platePopper[k];
                        }
            });
});
...
Object.keys(plateSelect).forEach(function (k) {
            if (k !== 'default' && !exports.hasOwnProperty(k)) Object.defineProperty(exports, k, {
                        enumerable: true,
                        get: function () {
                                    return plateSelect[k];
                        }
            });
});
Object.keys(plateSerializer).forEach(function (k) {
            if (k !== 'default' && !exports.hasOwnProperty(k)) Object.defineProperty(exports, k, {
                        enumerable: true,
                        get: function () {
                                    return plateSerializer[k];
                        }
            });
});
...
Object.keys(plateTableUi).forEach(function (k) {
            if (k !== 'default' && !exports.hasOwnProperty(k)) Object.defineProperty(exports, k, {
                        enumerable: true,
                        get: function () {
                                    return plateTableUi[k];
                        }
            });
});
Object.keys(plateToolbar).forEach(function (k) {
            if (k !== 'default' && !exports.hasOwnProperty(k)) Object.defineProperty(exports, k, {
                        enumerable: true,
                        get: function () {
                                    return plateToolbar[k];
                        }
            });
});
Object.keys(plateTrailingBlock).forEach(function (k) {
            if (k !== 'default' && !exports.hasOwnProperty(k)) Object.defineProperty(exports, k, {
                        enumerable: true,
                        get: function () {
                                    return plateTrailingBlock[k];
                        }
            });
});
Object.keys(plateUiButton).forEach(function (k) {
            if (k !== 'default' && !exports.hasOwnProperty(k)) Object.defineProperty(exports, k, {
                        enumerable: true,
                        get: function () {
                                    return plateUiButton[k];
                        }
            });
});
Object.keys(plateUiPopover).forEach(function (k) {
            if (k !== 'default' && !exports.hasOwnProperty(k)) Object.defineProperty(exports, k, {
                        enumerable: true,
                        get: function () {
                                    return plateUiPopover[k];
                        }
            });
});
